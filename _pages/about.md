...
My current research interests bridge the gap between structural and geotechnical engineering, focusing on:
  ...
  - Geotechnical earthquake engineering and the effects of liquefaction on existing structures.
      
  - Optimizing CPT-based lateral displacement assessments for urban-scale hazard analysis.
      
  - Advancing soil settlement predictions using field testing data for accelerated emergency projects.
  
  - Improving landslide hazard assessment and mitigation methods.
